...
*** YOU MUST IMPORT JUnit4 through maven repository for the tests to work ***

You can import JUnit4 by hovering the junit part of the import in the test,
choose the red lightbulb and choose import JUnit4.x
