...
public class StudentTest
{
    ...
    public void testSetGrade()
    {
        ...
        assertFalse("Should not change value if incorrect", instance.getGrade() == result);
        ...
        assertTrue("Should not change value if incorrect", instance.getGrade() == result);

        instance = new Student(5, "Henrik Kuhl");
        grade = 12;
        assertTrue("Correct value allowed?", instance.setGrade(grade));
        assertTrue("Value has not changed, although it is correct?", instance.getGrade() == grade * mult1);
    ...
    public void testSetStudentId()
    {
        ...
        assertFalse("Student id must not change if not valid", instance.getStudentId() == studentId);
